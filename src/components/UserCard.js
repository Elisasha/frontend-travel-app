...
import { setUser } from "../store/users/actions.ts";
import { database } from "../base";

export function UserCard() {
  const { uid } = useParams();
  const { user, curUser } = useSelector((state) => ({
  ...
  console.log("dicplay name:", user.displayName.split(" ")[0]);
  ...
  return (
    <div>
      <div className="bg-white rounded overflow-hidden shadow-lg min-w-200">
        <div className="text-center p-6  border-b">
          <img
            className="h-24 w-24 rounded-full mx-auto"
            src={user?.photoURL || defaultUserPic}
        ...
        <div className="border-b">
            ...
            <div className="flex items-center">
              ...
              <div className="pl-3">
                <p className="text-sm font-medium text-gray-800 leading-none">
                  {uid === curUser?.uid
                    ? `My trips`
                    : user.displayName.split(" ")[0] + `'s trips`}
                </p>
              </div>
            </div>
          </Link>
          ...
          >
            <div className="flex items-center">
              ...
              <div className="pl-3">
                <p className="text-sm font-medium text-gray-800 leading-none whitespace-nowrap">
                  {uid === curUser?.uid
                    ? `My friends`
                    : user.displayName.split(" ")[0] + `'s friends`}
                </p>
              </div>
              {uid == curUser?.uid && (
