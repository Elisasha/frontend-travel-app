    ...
    return (
        < div class="box" >
            <div class="box-wrapper">
                <div class=" bg-white flex items-center justify-between w-full p-3 shadow-sm border-gray-200">
                    {/* <div class="bg-gray-200 text-sm text-gray-500 leading-none border-2 border-gray-200 rounded-full inline-flex"> */}
                    <div class="text-sm text-gray-500 leading-none inline-flex">
                        <button class="inline-flex items-center transition-colors duration-300 ease-in focus:outline-none hover:text-blue-400 focus:text-blue-400 rounded-l-full px-1 py-2 active" id="grid">
                        ...
                        <button class="inline-flex items-center transition-colors duration-300 ease-in focus:outline-none hover:text-blue-400 focus:text-blue-400 rounded-r-full px-1 py-2" id="list">
                    ...
                    <div className="w-72 flex items-center border-gray-300 border rounded-full p-1">
                        ...
                        <input type="search" name="" placeholder="search for trips" x-model="q" class="w-full pl-4 text-sm outline-none focus:outline-none bg-transparent"></input>
                    </div>

                    <div class="select flex items-center">
                        <span className="text-sm m-2">Sort by:</span>
                        <div className="border-gray-300 border rounded-full p-1">
                            <select name="" id="" class="text-sm outline-none focus:outline-none bg-transparent">
